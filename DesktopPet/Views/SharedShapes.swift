...
//  比熊换成矢量插画（SpottedDogView）之后不再需要 FluffyBlobShape，
//  但狸花猫（TabbyCatView）的身体/头部轮廓仍然依赖它；SweatDropShape
//  则是两个角色都会用到的冒汗特效形状（SpottedDogView 里的插画头部
//  周围叠加的汗滴、TabbyCatView 奔跑喘气时的汗滴，用的是同一个形状）。
//
